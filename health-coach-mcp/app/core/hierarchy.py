...
class ComponentType(str, Enum):
    """Type of component a sub-intent represents"""
    RETRIEVER = "retriever"
    TOOL = "tool"
...
CONSTRAINT_HIERARCHY = {
    ...
    "sub_intents": {
        ...
        "evidence_research_exercise_meta_analysis": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates analysis/synthesis
        ...
        "evidence_research_exercise_rcts": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates analysis
            parent_category=Category.EXERCISE,
            parent_intent=IntentClass.EVIDENCE_RESEARCH,
            constraints=[
                Constraint(
        ...
        "evidence_research_exercise_mechanisms": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates explanations
            parent_category=Category.EXERCISE,
            parent_intent=IntentClass.EVIDENCE_RESEARCH,
            constraints=[
                Constraint(
        ...
        "evidence_research_nutrition_meta_analysis": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates synthesis
        ...
        "opinion_research_exercise_influencers": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates comparisons
            parent_category=Category.EXERCISE,
        ...
        "plan_exercise_program_design": SubIntent(
            ...
            component_type=ComponentType.TOOL,  # Generates plans
            parent_category=Category.EXERCISE,
        ...
        "task_exercise_tracking": SubIntent(
            ...
            component_type=ComponentType.RETRIEVER,  # Fetches data/automates
            parent_category=Category.EXERCISE,
